...
public class Prices_GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Slope_Supply_Curve.setMaximum(6);

        Slope_Demand_Curve.setMaximum(6);
        ...
        Graph.setMinimumSize(new java.awt.Dimension(250, 350));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(Graph, javax.swing.GroupLayout.PREFERRED_SIZE, 496, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(Graph, javax.swing.GroupLayout.PREFERRED_SIZE, 325, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void Compute_BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Compute_BtnActionPerformed
        ...
        try{
            ...
            WTP_Max = Double.parseDouble(Max_WTP.getText());
            OC_Min  = Double.parseDouble(Min_OC.getText());
            slope_demand =  (double)(Slope_Demand_Curve.getValue());
            slope_supply = (double)(Slope_Supply_Curve.getValue());
            
            pt_market market = new pt_market(WTP_Max, OC_Min, slope_demand, slope_supply);
            
            Supply_Curve = new ArrayList<>();
            Demand_Curve = new ArrayList<>();
            
            for(int i = 0; i<20; i++){
                Supply_Curve.add(market.getSupplyCurve(i));
            }
            
            for(int i = 0; i<20; i++){
                Demand_Curve.add(market.getDemandCurve(i));
            }
            
            Graph_Panel gp = new Graph_Panel(Supply_Curve, Demand_Curve);
    ...
    private void Reset_BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Reset_BtnActionPerformed
        ...
        Res_Consumer_Surplus.setText("");
        Res_Producer_Surplus.setText("");
        Res_Tot_Surplus.setText("");
        Res_EQ_Price.setText("");
        Res_EQ_Qty.setText("");

        Max_WTP.setText("");
        Min_OC.setText("");
        
        Slope_Demand_Curve.setValue(1);
        Slope_Supply_Curve.setValue(1);
